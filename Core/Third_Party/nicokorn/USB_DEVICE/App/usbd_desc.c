...
__ALIGN_BEGIN uint8_t USBD_FS_DeviceDesc2[USB_LEN_DEV_DESC] __ALIGN_END =
{
    18,                                 /* bLength = 18 bytes */
...
/* USB Standard Device Descriptor */
__ALIGN_BEGIN uint8_t USBD_FS_DeviceQualifierDesc2[USB_LEN_DEV_QUALIFIER_DESC] __ALIGN_END =
{
...
{
  UNUSED(speed);
  *length = sizeof(USBD_FS_DeviceDesc2);
  return USBD_FS_DeviceDesc2;
}
