...
C_SRCS += \
../Core/Third_Party/nicokorn/Core/Src/usbd_core.c \
../Core/Third_Party/nicokorn/Core/Src/usbd_ctlreq.c \
../Core/Third_Party/nicokorn/Core/Src/usbd_ioreq.c 

OBJS += \
./Core/Third_Party/nicokorn/Core/Src/usbd_core.o \
./Core/Third_Party/nicokorn/Core/Src/usbd_ctlreq.o \
./Core/Third_Party/nicokorn/Core/Src/usbd_ioreq.o 

C_DEPS += \
./Core/Third_Party/nicokorn/Core/Src/usbd_core.d \
./Core/Third_Party/nicokorn/Core/Src/usbd_ctlreq.d \
./Core/Third_Party/nicokorn/Core/Src/usbd_ioreq.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Third_Party/nicokorn/Core/Src/%.o Core/Third_Party/nicokorn/Core/Src/%.su Core/Third_Party/nicokorn/Core/Src/%.cyclo: ../Core/Third_Party/nicokorn/Core/Src/%.c Core/Third_Party/nicokorn/Core/Src/subdir.mk
...
clean: clean-Core-2f-Third_Party-2f-nicokorn-2f-Core-2f-Src

clean-Core-2f-Third_Party-2f-nicokorn-2f-Core-2f-Src:
	-$(RM) ./Core/Third_Party/nicokorn/Core/Src/usbd_core.cyclo ./Core/Third_Party/nicokorn/Core/Src/usbd_core.d ./Core/Third_Party/nicokorn/Core/Src/usbd_core.o ./Core/Third_Party/nicokorn/Core/Src/usbd_core.su ./Core/Third_Party/nicokorn/Core/Src/usbd_ctlreq.cyclo ./Core/Third_Party/nicokorn/Core/Src/usbd_ctlreq.d ./Core/Third_Party/nicokorn/Core/Src/usbd_ctlreq.o ./Core/Third_Party/nicokorn/Core/Src/usbd_ctlreq.su ./Core/Third_Party/nicokorn/Core/Src/usbd_ioreq.cyclo ./Core/Third_Party/nicokorn/Core/Src/usbd_ioreq.d ./Core/Third_Party/nicokorn/Core/Src/usbd_ioreq.o ./Core/Third_Party/nicokorn/Core/Src/usbd_ioreq.su

.PHONY: clean-Core-2f-Third_Party-2f-nicokorn-2f-Core-2f-Src
