...
C_SRCS += \
../Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/FreeRTOS_TCP_Unit_test.c 

OBJS += \
./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/FreeRTOS_TCP_Unit_test.o 

C_DEPS += \
./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/FreeRTOS_TCP_Unit_test.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/%.o Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/%.su Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/%.cyclo: ../Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/%.c Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/subdir.mk
...
clean: clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-unit-2d-test

clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-unit-2d-test:
	-$(RM) ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/FreeRTOS_TCP_Unit_test.cyclo ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/FreeRTOS_TCP_Unit_test.d ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/FreeRTOS_TCP_Unit_test.o ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/FreeRTOS_TCP_Unit_test.su

.PHONY: clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-unit-2d-test
