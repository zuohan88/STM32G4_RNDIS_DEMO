...
C_SRCS += \
../Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/stubs/FreeRTOS_ARP_stubs.c 

OBJS += \
./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/stubs/FreeRTOS_ARP_stubs.o 

C_DEPS += \
./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/stubs/FreeRTOS_ARP_stubs.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/stubs/%.o Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/stubs/%.su Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/stubs/%.cyclo: ../Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/stubs/%.c Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/stubs/subdir.mk
...
clean: clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-unit-2d-test-2f-stubs

clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-unit-2d-test-2f-stubs:
	-$(RM) ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/stubs/FreeRTOS_ARP_stubs.cyclo ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/stubs/FreeRTOS_ARP_stubs.d ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/stubs/FreeRTOS_ARP_stubs.o ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/unit-test/stubs/FreeRTOS_ARP_stubs.su

.PHONY: clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-unit-2d-test-2f-stubs
