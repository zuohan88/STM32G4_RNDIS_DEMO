...
C_SRCS += \
../Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/Socket/vSocketClose/vSocketClose_harness.c 

OBJS += \
./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/Socket/vSocketClose/vSocketClose_harness.o 

C_DEPS += \
./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/Socket/vSocketClose/vSocketClose_harness.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/Socket/vSocketClose/%.o Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/Socket/vSocketClose/%.su Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/Socket/vSocketClose/%.cyclo: ../Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/Socket/vSocketClose/%.c Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/Socket/vSocketClose/subdir.mk
...
clean: clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-cbmc-2f-proofs-2f-Socket-2f-vSocketClose

clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-cbmc-2f-proofs-2f-Socket-2f-vSocketClose:
...
.PHONY: clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-cbmc-2f-proofs-2f-Socket-2f-vSocketClose
