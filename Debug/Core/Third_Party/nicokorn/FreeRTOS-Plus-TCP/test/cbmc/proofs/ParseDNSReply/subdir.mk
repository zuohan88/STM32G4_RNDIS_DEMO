...
C_SRCS += \
../Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/ParseDNSReply/ParseDNSReply_harness.c 

OBJS += \
./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/ParseDNSReply/ParseDNSReply_harness.o 

C_DEPS += \
./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/ParseDNSReply/ParseDNSReply_harness.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/ParseDNSReply/%.o Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/ParseDNSReply/%.su Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/ParseDNSReply/%.cyclo: ../Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/ParseDNSReply/%.c Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/ParseDNSReply/subdir.mk
...
clean: clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-cbmc-2f-proofs-2f-ParseDNSReply

clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-cbmc-2f-proofs-2f-ParseDNSReply:
	-$(RM) ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/ParseDNSReply/ParseDNSReply_harness.cyclo ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/ParseDNSReply/ParseDNSReply_harness.d ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/ParseDNSReply/ParseDNSReply_harness.o ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/ParseDNSReply/ParseDNSReply_harness.su

.PHONY: clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-cbmc-2f-proofs-2f-ParseDNSReply
