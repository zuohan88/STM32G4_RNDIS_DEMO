...
C_SRCS += \
../Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/IP/SendEventToIPTask/SendEventToIPTask_harness.c 

OBJS += \
./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/IP/SendEventToIPTask/SendEventToIPTask_harness.o 

C_DEPS += \
./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/IP/SendEventToIPTask/SendEventToIPTask_harness.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/IP/SendEventToIPTask/%.o Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/IP/SendEventToIPTask/%.su Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/IP/SendEventToIPTask/%.cyclo: ../Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/IP/SendEventToIPTask/%.c Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/IP/SendEventToIPTask/subdir.mk
...
clean: clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-cbmc-2f-proofs-2f-IP-2f-SendEventToIPTask

clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-cbmc-2f-proofs-2f-IP-2f-SendEventToIPTask:
	-$(RM) ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/IP/SendEventToIPTask/SendEventToIPTask_harness.cyclo ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/IP/SendEventToIPTask/SendEventToIPTask_harness.d ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/IP/SendEventToIPTask/SendEventToIPTask_harness.o ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/cbmc/proofs/IP/SendEventToIPTask/SendEventToIPTask_harness.su

.PHONY: clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-cbmc-2f-proofs-2f-IP-2f-SendEventToIPTask
