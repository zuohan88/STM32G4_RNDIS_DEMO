...
C_SRCS += \
../Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/build-combination/Common/main.c 

OBJS += \
./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/build-combination/Common/main.o 

C_DEPS += \
./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/build-combination/Common/main.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/build-combination/Common/%.o Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/build-combination/Common/%.su Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/build-combination/Common/%.cyclo: ../Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/build-combination/Common/%.c Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/build-combination/Common/subdir.mk
...
clean: clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-build-2d-combination-2f-Common

clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-build-2d-combination-2f-Common:
	-$(RM) ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/build-combination/Common/main.cyclo ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/build-combination/Common/main.d ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/build-combination/Common/main.o ./Core/Third_Party/nicokorn/FreeRTOS-Plus-TCP/test/build-combination/Common/main.su

.PHONY: clean-Core-2f-Third_Party-2f-nicokorn-2f-FreeRTOS-2d-Plus-2d-TCP-2f-test-2f-build-2d-combination-2f-Common
